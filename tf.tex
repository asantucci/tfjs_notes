...
\lstinputlisting[basicstyle=\tiny,language=JavaScript]{html_examples/toxicity.html}
...
\lstinputlisting[firstline=3,lastline=4,basicstyle=\tiny,language=JavaScript]{html_examples/mobilenet.html}
...
\lstinputlisting[firstline=6,lastline=9,basicstyle=\tiny,language=JavaScript]{html_examples/mobilenet.html}
...
\lstinputlisting[firstline=10,lastline=21,basicstyle=\tiny,language=JavaScript]{html_examples/mobilenet.html}
...
\lstinputlisting[basicstyle=\tiny,language=JavaScript]{html_examples/mobilenet.html}
...
\lstinputlisting[basicstyle=\tiny,language=JavaScript]{html_examples/linear.html}
